...
RotationInspector::RotationInspector(QWidget* parent) :
...
void RotationInspector::setupConnections() {
...
void RotationInspector::populateProperties() {
...
void RotationInspector::updateAxis() {
