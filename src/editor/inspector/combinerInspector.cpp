...
CombinerInspector::CombinerInspector(QWidget* parent) :
    ...
    mFogCheckBox.setToolTip("Enables GPU fog for this particle. When enabled, color is blended with scene fog based on distance.");
...
void CombinerInspector::populateProperties() {
