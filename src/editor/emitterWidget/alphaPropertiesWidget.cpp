...
EmitterWidget::AlphaPropertiesWidget::AlphaPropertiesWidget(QWidget* parent) :
    QWidget{parent} {
...
void EmitterWidget::AlphaPropertiesWidget::setProperties(const Ptcl::Emitter::AlphaProperties& properties) {
    mProps = properties;
