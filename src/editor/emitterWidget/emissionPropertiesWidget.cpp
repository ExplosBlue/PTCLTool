...
EmitterWidget::EmissionPropertiesWidget::EmissionPropertiesWidget(QWidget* parent) :
    QWidget{parent} {
...
void EmitterWidget::EmissionPropertiesWidget::setProperties(const Ptcl::Emitter::EmissionProperties& properties) {
